...
class MegaDepthDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image1_gray = np.expand_dims(rgb2gray(image1), 0)
        image2_gray = np.expand_dims(rgb2gray(image2), 0)
        ...
        return {'image1': torch.from_numpy(image1.astype(np.float32)),
                'gray1': torch.from_numpy(image1_gray.astype(np.float32)),
                ...
                'gray2': torch.from_numpy(image2_gray.astype(np.float32)), 
